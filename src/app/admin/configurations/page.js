...
import { Search, Trash2, Ellipsis } from "lucide-react";
      ...
      <div className="flex">
        ...
        <div className="flex-1 p-4 flex flex-col w-full">
          <div className="flex justify-between items-center mb-6">
            <div>
              <h1 className="text-xl text-gray-600 font-medium">Configurations</h1>
            </div>
          ...
          <Tabs defaultValue="customer" className="w-full mb-4" onValueChange={setActiveTab}>
            ...
            <TabsContent value="add-supplier" className="mt-4">
